...
const Boxe = () => {
  return (
    <>
        ...
        <section className="boxe-hero">
          <div className="hero-content">
            ...
            <p className="hero-lead">
              ...
              competizione nel pugilato olimpico, sia per chi desidera
              migliorare forma fisica e tecnica nella Gym Boxe. La struttura
              TSC, affiliata alla Federazione Pugilistica Italiana da 5 anni,
              garantisce un ambiente professionale e riconosciuto, ideale per
              crescere in sicurezza e con metodo. Gli allenamenti combinano
              lavoro al sacco, sparring controllato, esercizi di mobilità e
              conditioning specifico per aumentare resistenza, velocità e
              potenza.
            </p>
      ...
      <div className="VideosBoxe">
        <h2 className="VideosTitleBoxe">Video allenamenti</h2>
        <div className="VideoContainer">
          <iframe
            className="video-iframe"
            src="https://www.youtube.com/embed/f0tJpxZgX1w"
          ></iframe>
          <iframe
            width="360"
            height="640"
            src="https://www.youtube.com/embed/iDYC3dB8rH4"
